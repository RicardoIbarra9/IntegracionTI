            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('registrar_usuario_externo')}}">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label>Sexo</label>
                                        <select name="sexo" class="form-control selectric">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input id="contrasena-confirmada" type="password" class="form-control" name="contrasena-confirmada">
                                    </div>
                                </div>
